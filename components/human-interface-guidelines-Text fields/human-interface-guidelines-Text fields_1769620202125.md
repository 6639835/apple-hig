# <span id="page-0-1"></span>**Text fields**
...
Text [fields](#page-0-1) Best [practices](#page-0-0) Platform [considerations](#page-1-0)

[Resources](#page-3-0) [Change](#page-3-1) log
...
<span id="page-0-0"></span>**Use secure text fields to hide private data.** Always use a secure text field when your app asks for sensitive data, such as a password. For developer guidance, see *[SecureField](https://developer.apple.com/documentation/SwiftUI/SecureField)*.
...
| Clipped text | Wrapped text | Truncated text |
|--------------|--------------|----------------|
...
<span id="page-1-1"></span><span id="page-1-0"></span>**Use images and buttons to provide clarity and functionality in text fields.** You can display custom images in both ends of a text field, or you can add a system-provided button, such as the Bookmarks button. In general, use the leading end of a text field to indicate a field's purpose and the trailing end to offer additional features, such as bookmarking.

### <span id="page-2-0"></span>**[macOS](#page-2-0)**

**Consider using a combo box if you need to pair text input with a list of choices.** For related guidance, see [Combo](https://developer.apple.com/design/human-interface-guidelines/combo-boxes) boxes.

#### **[watchOS](#page-2-1)**

<span id="page-2-1"></span>**Present a text field only when necessary.** Whenever possible, prefer displaying a list of options rather than requiring text entry.
...
<span id="page-3-3"></span>*[TextField](https://developer.apple.com/documentation/SwiftUI/TextField)* — SwiftUI
