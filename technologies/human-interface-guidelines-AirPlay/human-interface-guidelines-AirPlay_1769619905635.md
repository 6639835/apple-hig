...
[AirPlay](#page-0-1) Best [practices](#page-0-0) Using [AirPlay](#page-1-0) icons [Referring](#page-2-0) to AirPlay Platform [considerations](#page-3-0) [Resources](#page-4-0) [Change](#page-4-1) log
...
**Support remote control events.** When you do, people can choose actions like play, pause, and fast forward on the lock screen, and through interaction with Siri or HomePod. For developer guidance, see Remote [command](https://developer.apple.com/documentation/MediaPlayer/remote-command-center-events) center events.
...
### **Black [AirPlay](#page-1-1) icon**

<span id="page-1-1"></span><span id="page-1-0"></span>Use the black AirPlay icon on white or light backgrounds when other technology icons also appear in black.

![](_page_2_Picture_0.jpeg)

![](_page_2_Picture_1.jpeg)

### <span id="page-2-1"></span>**White [AirPlay](#page-2-1) icon**

Use the white AirPlay icon on black or dark backgrounds when other technology icons also appear in white.

![](_page_2_Picture_4.jpeg)

### **[Custom](#page-2-2) color AirPlay icon**

<span id="page-2-2"></span>Use a custom color when other technology icons also appear in the same color.
...
<span id="page-2-0"></span>**Always use** *AirPlay* **as a noun.**
...
<span id="page-3-0"></span>*No additional considerations for iOS, iPadOS, macOS, tvOS, or visionOS. Not supported in watchOS.*
...
Apple [Trademark](https://www.apple.com/legal/intellectual-property/trademark/appletmlist.html) List
...
<span id="page-4-3"></span>[AVFoundation](https://developer.apple.com/documentation/AVFoundation)

[AVKit](https://developer.apple.com/documentation/AVKit)

### **[Videos](#page-4-4)**

<span id="page-4-4"></span>![](_page_4_Picture_9.jpeg)

**[Reaching](https://developer.apple.com/videos/play/wwdc2019/501) the Big Screen with AirPlay 2**
