...
iPhone [interactions](#page-0-0)

[Layout](#page-1-0)

[Color](#page-2-0)

Icons and [images](#page-2-1)

Error [handling](#page-3-0)

Platform [considerations](#page-3-1) [Resources](#page-4-0)
...
To learn how to create various types of CarPlay apps and use the system-provided templates, see CarPlay App [Programming](https://developer.apple.com/carplay/documentation/CarPlay-App-Programming-Guide.pdf) Guide. The general design guidelines below apply to all types of CarPlay apps.

#### **iPhone [interactions](#page-0-0)**

<span id="page-0-0"></span>CarPlay shows compatible apps from the connected iPhone on the car's built-in display, applying simplified interfaces that are optimized for use while driving.
...
<span id="page-2-0"></span>**In general, prefer a limited color palette that coordinates with your app logo.** Subtle use of color is a great way to communicate your brand.
...
**Choose colors that help you communicate effectively with everyone.** Different people see and interpret colors differently. For guidance on using colors in ways that people appreciate, see [Inclusive](https://developer.apple.com/design/human-interface-guidelines/color#Inclusive-color) color.
...
<span id="page-2-1"></span>**Don't use black for your icon's background.** Lighten a black background or add a border so the icon doesn't blend into the display background.
...
### <span id="page-3-0"></span>**Error [handling](#page-3-0)**
...
<span id="page-3-1"></span>*No additional considerations for iOS. Not supported in iPadOS, macOS, tvOS, visionOS, or watchOS.*

# <span id="page-4-4"></span><span id="page-4-3"></span><span id="page-4-2"></span><span id="page-4-0"></span>[CarPlay](http://developer.apple.com/carplay/) CarPlay App [Programming](https://developer.apple.com/carplay/documentation/CarPlay-App-Programming-Guide.pdf) Guide **[Resources](#page-4-0) [Related](#page-4-2) Developer [documentation](#page-4-3) [Videos](#page-4-4) [Turbocharge](https://developer.apple.com/videos/play/wwdc2025/216) your app for CarPlay [Change](#page-4-1) log**

**Date Changes**

<span id="page-4-1"></span>May 2, 2023 Consolidated guidance into one page.