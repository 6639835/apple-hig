# <span id="page-0-1"></span>**Charting data**
...
[Charting](#page-0-1) data Best [practices](#page-0-0) [Designing](#page-1-0) effective charts Platform [considerations](#page-3-0) [Resources](#page-4-0) [Change](#page-4-1) log
...
<span id="page-0-0"></span>**Use a chart when you want to highlight important information about a dataset.** Charts are visually prominent, so they tend to draw people's attention. Take advantage of this prominence by clearly communicating what people can learn from the data they care about.
...
**Make every chart in your app accessible.** A chart communicates visually through graphical representations of data and visual descriptions. In addition to the visual descriptions you display, it's crucial to provide both accessibility labels that describe chart values and components, and accessibility elements that help people interact with the chart. For guidance, see [Enhancing](https://developer.apple.com/design/human-interface-guidelines/charts#Enhancing-the-accessibility-of-a-chart) the [accessibility](https://developer.apple.com/design/human-interface-guidelines/charts#Enhancing-the-accessibility-of-a-chart) of a chart.

#### **[Designing](#page-1-0) effective charts**

<span id="page-1-0"></span>**In general, prefer using common chart types.** People tend to be familiar with common chart types — such as bar charts and line charts — so using one of these types in your app can make it more likely that people will already know how to read your chart. For guidance, see [Charts.](https://developer.apple.com/design/human-interface-guidelines/charts)
...
# <span id="page-4-3"></span><span id="page-4-2"></span><span id="page-4-0"></span>[Charts](https://developer.apple.com/design/human-interface-guidelines/charts) Swift [Charts](https://developer.apple.com/documentation/Charts) **[Resources](#page-4-0) [Related](#page-4-2) Developer [documentation](#page-4-3) [Videos](#page-4-4)**

#### **[Change](#page-4-1) log**

**third [dimension](https://developer.apple.com/videos/play/wwdc2025/313)**

<span id="page-4-4"></span>**Bring Swift Charts to the**

**Date Changes**

**Design app [experiences](https://developer.apple.com/videos/play/wwdc2022/110342) with**

**Design an [effective](https://developer.apple.com/videos/play/wwdc2022/110340) chart**

**charts**

<span id="page-4-1"></span>September 23, 2022 New page.