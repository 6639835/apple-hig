# <span id="page-0-1"></span>**Immersive experiences**
...
Immersive [experiences](#page-0-1) Immersion and [passthrough](#page-0-0) Best [practices](#page-2-0) [Promoting](#page-3-0) comfort [Transitioning](#page-4-0) between immersive styles [Displaying](#page-4-1) virtual hands Creating an [environment](#page-4-2) Platform [considerations](#page-5-0) [Resources](#page-6-0) [Change](#page-6-1) log
...
## **Immersion and [passthrough](#page-0-0)**
...
Without dimmed passthrough With dimmed passthrough
...
Full Space (Progressive) Full Space (Immersive) Full Space (Mixed)

![](_page_2_Picture_5.jpeg)

Mixed immersion style in a Full Space blending in-app objects with real-world surroundings

## <span id="page-2-0"></span>**Best [practices](#page-2-0)**
...
# **[Transitioning](#page-4-0) between immersive styles**

<span id="page-4-0"></span>**Design smooth, predictable transitions when changing immersion.** Help people prepare for different experiences by providing gentle transitions that let people visually track changes. Avoid sudden, jarring transitions that might be disorienting or uncomfortable. For developer guidance, see *[CoordinateSpaceProtocol](https://developer.apple.com/documentation/SwiftUI/CoordinateSpaceProtocol)*.
...
# **[Displaying](#page-4-1) virtual hands**
...
<span id="page-4-1"></span>**Use caution if you create virtual hands that are larger than the viewer's hands.** Virtual hands that are significantly bigger than human hands can prevent people from seeing the content they're interested in and can make interactions feel clumsy. Also, large virtual hands can seem out of proportion with the space, appearing to be too close to the viewer's face.
...
## **Creating an [environment](#page-4-2)**

<span id="page-4-2"></span>When your app or game transitions to a Full Space, you can replace passthrough with a custom environment that partially or completely surrounds a person, transporting them to a new place.

The following guidelines can help you design a beautiful environment that people appreciate.
...
<span id="page-5-0"></span>*Not supported in iOS, iPadOS, macOS, tvOS, or watchOS.*
...
<span id="page-6-3"></span>Creating fully immersive [experiences](https://developer.apple.com/documentation/visionOS/creating-fully-immersive-experiences) in your app — visionOS

[Incorporating](https://developer.apple.com/documentation/visionOS/incorporating-real-world-surroundings-in-an-immersive-experience) real-world surroundings in an immersive experience — visionOS

*[ImmersionStyle](https://developer.apple.com/documentation/SwiftUI/ImmersionStyle)* — visionOS

[Immersive](https://developer.apple.com/documentation/SwiftUI/Immersive-spaces) spaces — SwiftUI

#### **[Videos](#page-6-4)**

<span id="page-6-4"></span>![](_page_6_Picture_10.jpeg)

**[Principles](https://developer.apple.com/videos/play/wwdc2023/10072) of spatial design Design spatial SharePlay [experiences](https://developer.apple.com/videos/play/wwdc2023/10075)**

**Create custom [environments](https://developer.apple.com/videos/play/wwdc2024/10087) for your immersive apps in visionOS**
...
| Date              | Changes                                                                                                    |
|-------------------|------------------------------------------------------------------------------------------------------------|
| June 9, 2025      | Clarified guidance and noted the availability of por‐<br>trait-oriented progressive immersion.             |
| November 19, 2024 | Refined immersion style guidance and added artwork.                                                        |
| June 10, 2024     | Added guidance for tinting passthrough and specify‐<br>ing initial, minimum, and maximum immersion levels. |
| May 7, 2024       | Added guidance for creating an environment.                                                                |
| February 2, 2024  | Clarified guidance for choosing an immersion style<br>that matches the experience your app provides.       |
