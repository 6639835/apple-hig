...
#### [Augmented](#page-0-1) reality

Best [practices](#page-0-0) [Providing](#page-2-0) coaching [Helping](#page-3-0) people place objects Designing object [interactions](#page-4-0)

Offering a multiuser [experience](#page-5-0)

Reacting to [real-world](#page-5-1) objects

[Communicating](#page-5-2) with people Handling [interruptions](#page-7-0)

[Suggesting](#page-8-0) problem resolutions

Icons and [badges](#page-8-1) Platform [considerations](#page-9-0)
...
**Use audio and haptics to enhance the immersive experience.** A sound effect or bump sensation is a great way to confirm that a virtual object has made contact with a physical surface or other virtual object. Background music can also help envelop people in the virtual world. For guidance, see [Playing](https://developer.apple.com/design/human-interface-guidelines/playing-audio) audio and Playing [haptics.](https://developer.apple.com/design/human-interface-guidelines/playing-haptics)
...
#### **[Providing](#page-2-0) coaching**

<span id="page-2-0"></span>Before people can enjoy an AR experience in your app, they need to move their device in ways that lets ARKit evaluate the surroundings and detect surfaces. Consider using the built-in coaching view to show people what to do and provide feedback during the initialization process. You can also use the coaching view to help people reinitialize AR — a process known as *relocalization* — after an AR experience is interrupted by, for example, people switching briefly to a different app. For guidance on relocalization, see Handling [interruptions](#page-7-0); for developer guidance, see *[ARCoachingOverlayView](https://developer.apple.com/documentation/ARKit/ARCoachingOverlayView)*.
...
## <span id="page-4-0"></span>**Designing object [interactions](#page-4-0)**
...
Direct manipulation Indirect controls
...
## <span id="page-5-0"></span>**Offering a multiuser [experience](#page-5-0)**

When multiple people share your app's AR experience, each participant maps the environment independently and ARKit automatically merges the maps. For developer guidance, see *[is](https://developer.apple.com/documentation/ARKit/ARWorldTrackingConfiguration/isCollaborationEnabled) [CollaborationEnabled](https://developer.apple.com/documentation/ARKit/ARWorldTrackingConfiguration/isCollaborationEnabled)*.

**Consider allowing people occlusion.** If your app supports placing virtual objects behind people who appear in the device's camera feed, enhance the illusion of reality by letting the people occlude the objects. For developer guidance, see [Occluding](https://developer.apple.com/documentation/ARKit/occluding-virtual-content-with-people) virtual content with people.
...
#### **[Communicating](#page-5-2) with people**
...
<span id="page-5-2"></span>**Do Don't**

| Do                                                            | Don't                            |
|---------------------------------------------------------------|----------------------------------|
| Tap a location to place the [name of object to be<br>placed]. | Tap a plane to anchor an object. |
...
Prefer a 3D hint in a 3D context. If necessary, use a 2D hint in a 3D context.
...
## <span id="page-7-0"></span>**Handling [interruptions](#page-7-0)**

ARKit can't track device position and orientation during an interruption, such as when people briefly switch to another app or accept a phone call. After an interruption ends, previously placed virtual objects are likely to appear in the wrong real-world positions. When you support relocalization, ARKit attempts to restore those virtual objects to their original real-world positions using new information. For developer guidance, see [Managing](https://developer.apple.com/documentation/ARKit/managing-session-life-cycle-and-tracking-quality) Session Life Cycle and Tracking [Quality.](https://developer.apple.com/documentation/ARKit/managing-session-life-cycle-and-tracking-quality)
...
## <span id="page-8-0"></span>**[Suggesting](#page-8-0) problem resolutions**
...
| Surface detection takes too long. | Try moving around, turning on more lights, and making<br>sure your phone is pointed at a sufficiently textured<br>surface. |

#### **Icons and [badges](#page-8-1)**
...
<span id="page-8-1"></span>**Use the AR glyph as intended.** The glyph is strictly for initiating an ARKit-based experience. Never alter the glyph (other than adjusting its size and color), use it for other purposes, or use it in conjunction with AR experiences not created using ARKit.
...
<span id="page-11-3"></span>**[experiences](https://developer.apple.com/videos/play/wwdc2022/10131)**

<span id="page-11-1"></span>**[Related](#page-11-1)**
...
|                            |                 |
|                            |                 |
| Qualities of great AR      | Explore ARKit 5 |