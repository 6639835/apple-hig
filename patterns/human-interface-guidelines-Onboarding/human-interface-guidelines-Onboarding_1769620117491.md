# <span id="page-0-1"></span>**Onboarding**
...
Best [practices](#page-0-0) [Additional](#page-1-0) content [Additional](#page-1-1) requests Platform [considerations](#page-1-2) [Resources](#page-2-0) [Change](#page-2-1) log
...
<span id="page-0-0"></span>**If you need to present a prerequisite onboarding flow, design a brief, enjoyable experience that doesn't require people to memorize a lot of information.** When onboarding is quick and entertaining, people are more likely to complete it. In contrast, if you try to teach too much, people can feel overwhelmed and may be less likely to remember what they learned.

**If it makes sense to offer a separate tutorial, consider making it optional.** If you let people skip the tutorial when they first launch your app or game, don't present it again on subsequent

launches, but make sure it's easy for people to find if they want to view it later. For example, you could make the tutorial available in a help, account, or settings area within your app or game.
...
## <span id="page-1-0"></span>**[Additional](#page-1-0) content**
...
<span id="page-1-2"></span>*No additional considerations for iOS, iPadOS, macOS, tvOS, visionOS, or watchOS.*
...
[Offering](https://developer.apple.com/design/human-interface-guidelines/offering-help) help

#### **[Videos](#page-2-3)**

<span id="page-2-3"></span>![](_page_2_Picture_6.jpeg)

![](_page_2_Picture_7.jpeg)

![](_page_2_Picture_8.jpeg)

**[Discoverable](https://developer.apple.com/videos/play/wwdc2021/10126) design [Designing](https://developer.apple.com/videos/play/wwdc2019/802) Award Winning Apps and Games**
...
| Date          | Changes                                                                                              |
|---------------|------------------------------------------------------------------------------------------------------|
| June 10, 2024 | Clarified different approaches to onboarding and<br>added a guideline on displaying a splash screen. |
