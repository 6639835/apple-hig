...
#### <span id="page-2-2"></span>**Developer [documentation](#page-2-2)**
...
| Date         | Changes                                                       |
|--------------|---------------------------------------------------------------|
| June 9, 2025 | Added guidance for synchronizing game data through<br>iCloud. |