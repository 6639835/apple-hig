# <span id="page-0-1"></span>**Context menus**
...
[Context](#page-0-1) menus Best [practices](#page-0-0)
...
<span id="page-0-0"></span>**Support context menus consistently throughout your app.** If you provide context menus for items in some places but not in others, people won't know where they can use the feature and may think there's a problem.
...
A context menu seldom displays a title. In contrast, each item in a context menu needs to display a short label that clearly describes what it does. For guidance, see [Menus](https://developer.apple.com/design/human-interface-guidelines/menus#Labels) > Labels.
...
<span id="page-3-3"></span>*[contextMenu\(menuItems:\)](https://developer.apple.com/documentation/SwiftUI/View/contextMenu(menuItems:))* — SwiftUI
...
| September 14, 2022 | Refined guidance on including a submenu and added a<br>guideline on using a context menu to support object<br>creation in an iPadOS app. |