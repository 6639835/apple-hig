...
[Modality](#page-0-1) Best [practices](#page-0-0) Platform [considerations](#page-1-0) [Resources](#page-2-0)
...
To provide a temporary experience, like viewing media, or to help people perform a distinct, multistep task, like editing content, apps can offer a full-screen modal experience. In contrast, apps may also offer nonmodal types of full-screen experiences; for guidance, see [Going](https://developer.apple.com/design/human-interface-guidelines/going-full-screen) full [screen.](https://developer.apple.com/design/human-interface-guidelines/going-full-screen) visionOS apps can offer a range of immersive experiences; for guidance, see [Immersive](https://developer.apple.com/design/human-interface-guidelines/immersive-experiences) [experiences.](https://developer.apple.com/design/human-interface-guidelines/immersive-experiences)
...
<span id="page-1-0"></span>*No additional considerations for iOS, iPadOS, macOS, tvOS, visionOS, or watchOS.*
...
[Presentation](https://developer.apple.com/documentation/SwiftUI/View-Presentation) modifiers — SwiftUI

<span id="page-2-3"></span>*[UIModalPresentationStyle](https://developer.apple.com/documentation/UIKit/UIModalPresentationStyle)* — UIKit

Modal [Windows](https://developer.apple.com/documentation/AppKit/modal-windows-and-panels) and Panels — AppKit
...
| Date             | Changes                                                                                             |
|------------------|-----------------------------------------------------------------------------------------------------|
| December 5, 2023 | Enhanced guidance for in-depth modal experiences<br>and clarified guidance on multiple modal views. |
