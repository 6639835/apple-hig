...
[Motion](#page-0-2) Best [practices](#page-0-0) [Providing](#page-0-1) feedback Leveraging platform [capabilities](#page-1-0) Platform [considerations](#page-1-1) [Resources](#page-3-0) [Change](#page-3-1) log

Many system components automatically include motion, letting you offer familiar and consistent experiences throughout your app or game. System components might also adjust their motion in response to factors like accessibility settings or different input methods. For example, the movement of [Liquid](https://developer.apple.com/design/human-interface-guidelines/materials#Liquid-Glass) Glass responds to direct touch interaction with greater emphasis to reinforce the feeling of a tactile experience, but produces a more subdued effect when a person interacts using a trackpad.
...
## <span id="page-0-1"></span><span id="page-0-0"></span>**[Providing](#page-0-1) feedback**
...
## **Leveraging platform [capabilities](#page-1-0)**
...
<span id="page-1-0"></span>**Let people customize the visual experience of your game to optimize performance or battery life.** For example, consider letting people switch between power modes when the system detects the presence of an external power source.
...
<span id="page-2-0"></span>All layout- and appearance-based animations automatically include built-in easing that plays at the start and end of the animation. You can't turn off or customize easing.
...
<span id="page-3-3"></span>Animating views and [transitions](https://developer.apple.com/tutorials/SwiftUI/animating-views-and-transitions) — SwiftUI
...
**Create [custom](https://developer.apple.com/videos/play/wwdc2024/10151) visual effects with SwiftUI**

**Design [considerations](https://developer.apple.com/videos/play/wwdc2023/10078) for vision and motion**
...
| June 10, 2024     | Added game-specific examples and enhanced guid‐<br>ance for using motion in games. |
| February 2, 2024  | Enhanced guidance for minimizing peripheral motion<br>in visionOS apps.            |
