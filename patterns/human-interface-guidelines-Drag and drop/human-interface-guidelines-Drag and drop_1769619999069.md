...
[Drag](#page-0-1) and drop Best [practices](#page-0-0) [Providing](#page-1-0) feedback [Accepting](#page-2-0) drops Platform [considerations](#page-3-0) [Resources](#page-5-0) [Change](#page-5-1) log
...
**Offer alternative ways to accomplish drag-and-drop actions.** Sometimes, drag-and-drop operations are inconvenient or impossible for people to perform, so it's important to provide other ways to do the same things. For example, you can include menu commands that people can use to copy an item and move it to another location. In iOS and iPadOS, you can use accessibility APIs to identify sources and destinations so that people can use assistive technologies to drag and drop in your app (for developer guidance, see *[accessibilityDrag](https://developer.apple.com/documentation/ObjectiveC/NSObject-swift.class/accessibilityDragSourceDescriptors) [SourceDescriptors](https://developer.apple.com/documentation/ObjectiveC/NSObject-swift.class/accessibilityDragSourceDescriptors)* and *[accessibilityDropPointDescriptors](https://developer.apple.com/documentation/ObjectiveC/NSObject-swift.class/accessibilityDropPointDescriptors)*).
...
## **[Providing](#page-1-0) feedback**

<span id="page-1-0"></span>Drag and drop is a dynamic process that can result in multiple outcomes. To help people feel in control the process, it's crucial to provide clear and continuous feedback throughout.
...
### <span id="page-4-0"></span>**[visionOS](#page-4-0)**
...
[Universal](https://support.apple.com/en-us/HT212757) Control

#### <span id="page-5-3"></span>**Developer [documentation](#page-5-3)**

[Drag](https://developer.apple.com/documentation/UIKit/drag-and-drop) and drop — UIKit
...
**[What's](https://developer.apple.com/videos/play/wwdc2021/10059) new in UIKit SwiftUI on the Mac: The [finishing](https://developer.apple.com/videos/play/wwdc2021/10289) touches**

**[Designed](https://developer.apple.com/videos/play/wwdc2020/10206) for iPad**
