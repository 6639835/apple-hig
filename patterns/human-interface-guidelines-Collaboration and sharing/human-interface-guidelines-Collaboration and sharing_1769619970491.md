# <span id="page-0-1"></span>**Collaboration and sharing**
...
[Collaboration](#page-0-1) and sharing Best [practices](#page-0-0) Platform [considerations](#page-3-0) [Resources](#page-4-0) [Change](#page-4-1) log
...
You can take advantage of Messages integration and the system-provided sharing interfaces whether you implement collaboration and sharing through CloudKit, iCloud Drive, or a custom solution. To offer these features when you use a custom collaboration infrastructure, make sure your app also supports universal links (for developer guidance, see [Supporting](https://developer.apple.com/documentation/Xcode/supporting-universal-links-in-your-app) universal links in [your](https://developer.apple.com/documentation/Xcode/supporting-universal-links-in-your-app) app).
...
<span id="page-3-0"></span>*No additional considerations for iOS, iPadOS, or macOS. Not available in tvOS.*

### **[visionOS](#page-3-1)**

<span id="page-3-1"></span>By default, the system supports screen sharing for an app running in the Shared Space by streaming the current window to other collaborators. If one person transitions the app to a Full Space while sharing is in progress, the system pauses the stream for other people until the app returns to the Shared Space. For guidance, see Immersive [experiences.](https://developer.apple.com/design/human-interface-guidelines/immersive-experiences)

### **[watchOS](#page-3-2)**

<span id="page-3-2"></span>In your SwiftUI app running in watchOS, use *[ShareLink](https://developer.apple.com/documentation/SwiftUI/ShareLink)* to present the system-provided share sheet.

# <span id="page-4-0"></span>**[Resources](#page-4-0)**

#### <span id="page-4-2"></span>**[Related](#page-4-2)**

[Activity](https://developer.apple.com/design/human-interface-guidelines/activity-views) views

#### <span id="page-4-3"></span>**Developer [documentation](#page-4-3)**

[Shared](https://developer.apple.com/documentation/SharedWithYou) with You

*[ShareLink](https://developer.apple.com/documentation/SwiftUI/ShareLink)* — SwiftUI

#### **[Videos](#page-4-4)**

<span id="page-4-4"></span>![](_page_4_Picture_7.jpeg)
...
| Date               | Changes                                                                                          |
|--------------------|--------------------------------------------------------------------------------------------------|
| December 5, 2023   | Added artwork illustrating button placement and vari‐<br>ous types of collaboration permissions. |
